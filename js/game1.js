var ROWS, COLS, cellWidth, cellHeight, timeStep, activeSnake, pastSnakes, keyboardLock, snakeData, map;

// map dimensions
    ROWS =  7 //model's number of rows
    COLS =  7 

    cellWidth = 100 //draw size
    cellHeight = 100 
    ...
    snakeData = [{snakeLength:3, startPos:[0, 3], goalPos:[6, 2], heading:DIRECTION_ENUM.RIGHT, snakeColor:'#E5FF00'},
...
var Game = {
    ...
    //
    createSnakeWith : function(properties){
    ...
    updateSnakes : function(cellVal,snakeArray){
